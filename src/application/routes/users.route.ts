...
import { registerUserRules } from '../middlewares/validateUserRegistration.ts'
import { updateUserRules } from '../middlewares/validateUserUpdate.ts'
import { userExistenceAsParamsRules, userExistenceAsBodyRules, userIdInNotificationsExistenceAsParamsRules } from '../middlewares/validateUserExistence.ts'
import { validateRequest } from '../middlewares/validateRequest.ts'
import { userExistenceInNotificationsRules } from '../middlewares/validateUserIdExistenceInNotifications.ts'
import { newNotificationRules } from '../middlewares/validateUserNewNotification.ts'
import { userNotificationUpdateRules } from '../middlewares/validateUserNotificationUpdate.ts'
import { userNotificationIdExistenceAsParamsRules } from '../middlewares/validateNotificationExistence.ts'
